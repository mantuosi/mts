    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
        ...
        <form action="/admin/addNotice" method="post" class="add-article-form">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>发布公告</span></h2>
              <div class="add-article-box-content">
                <p><label>状态：</label>
                <input type="radio" name="state" value="1" checked/>立即发布 
                <input type="radio" name="state" value="0" />暂不发布</p>
               
              </div>
              <div class="add-article-box-footer">
                <button class="btn btn-primary" type="submit" name="submit">完成</button>
              </div>
            </div>
          </div>
        </form>
